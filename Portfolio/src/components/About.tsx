...
import { Code, Lightbulb, Target, Award, Coffee, Heart } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  const stats = [
    { icon: Code, label: "Projects Completed", value: "3+", gradient: "from-purple-500 to-pink-500" },
    { icon: Award, label: "Technologies Mastered", value: "12+", gradient: "from-cyan-500 to-blue-500" },
    { icon: Lightbulb, label: "Years Learning", value: "4+", gradient: "from-green-500 to-teal-500" },
    { icon: Coffee, label: "Cups of Tea", value: "∞", gradient: "from-orange-500 to-red-500" }
  ];
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat, index) => (
                <motion.div
                  key={index}
                  className="bg-gray-800/30 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 group text-center"
                ...
                >
                  <motion.div
                    className={`w-12 h-12 bg-gradient-to-r ${stat.gradient} rounded-lg flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300`}
